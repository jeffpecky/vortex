...
export async function call(
  ...
  try {
    ...
    if (parsed.type === 'status') {
      const currentSpend = getTotalInputTokens() + getTotalOutputTokens()
      onDone(getGoalStatusText(threadId, () => currentSpend), { display: 'system' })
      return null
    }
    ...
    const currentSpend = getTotalInputTokens() + getTotalOutputTokens()
    const goal = setThreadGoalHook(_context, threadId, parsed.objective, undefined, () => currentSpend)
